...
@Component({
  selector: 'app-panel-import',
  templateUrl: './panel-import.component.html',
  styleUrls: ['./panel-import.component.css'],
  providers: [ScheduleService, AppConfig]
})
export class PanelImportComponent implements OnInit {
